...
<section>
  ...
  <grid>
    ...
    <label><input type="checkbox" checked={true}> Cursor Control Keys</label>
    <label><input type="checkbox" checked={true}> Login Auth</label>
    <label><input type="checkbox" checked={true}> Konami Code</label>
